...
export function CarburantView() {
  ...
  const fetchCarburantData = useCallback(async () => {
    ...
    setLoading(true)
    try {
      const res = await fetch(`/api/v1/carburant?chantierId=${activeChantierId}`)
      if (res.ok) {
        const data = await res.json()
  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/v1/carburant/stats?${params}`)
      if (res.ok) {
        const data = await res.json()
  ...
  async function handleCreateStock() {
    ...
    try {
      const res = await fetch('/api/v1/carburant/stock', {
        method: 'POST',
  ...
  async function handleCreateEntree() {
    ...
    try {
      ...
      const res = await fetch('/api/v1/carburant/entrees', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          chantierId: activeChantierId,
  ...
  async function handleDeleteEntree(id: string) {
    try {
      const res = await fetch(`/api/v1/carburant/entrees/${id}`, {
        method: 'DELETE',
      })
      if (res.ok) {
  ...
  async function handleCreateSortie() {
    ...
    setFormSubmitting(true)
    try {
      const res = await fetch('/api/v1/carburant/sorties', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          chantierId: activeChantierId,
  ...
  async function handleDeleteSortie(id: string) {
    try {
      const res = await fetch(`/api/v1/carburant/sorties/${id}`, {
        method: 'DELETE',
      })
      if (res.ok) {
  ...
  async function handleCreateAchat() {
    ...
    try {
      ...
      const res = await fetch('/api/v1/carburant/achats', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          chantierId: activeChantierId,
  ...
  async function handleDeleteAchat(id: string) {
    try {
      const res = await fetch(`/api/v1/carburant/achats/${id}`, {
        method: 'DELETE',
      })
      if (res.ok) {
  ...
  async function handleCreateReleve() {
    ...
    setFormSubmitting(true)
    try {
      const res = await fetch('/api/v1/carburant/releves', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          chantierId: activeChantierId,
  ...
  async function handleDeleteReleve(id: string) {
    try {
      const res = await fetch(`/api/v1/carburant/releves/${id}`, {
        method: 'DELETE',
      })
      if (res.ok) {
  ...
  async function handleConfirmDelete() {
    ...
    try {
      ...
      switch (deletingInfo.type) {
        case 'entree':
          res = await fetch(`/api/v1/carburant/entrees/${deletingInfo.id}`, {
            method: 'DELETE',
          })
          break
        case 'sortie':
          res = await fetch(`/api/v1/carburant/sorties/${deletingInfo.id}`, {
            method: 'DELETE',
          })
          break
        case 'achat':
          res = await fetch(`/api/v1/carburant/achats/${deletingInfo.id}`, {
            method: 'DELETE',
          })
          break
        case 'releve':
          res = await fetch(`/api/v1/carburant/releves/${deletingInfo.id}`, {
            method: 'DELETE',
          })
          break
        case 'stock':
          res = await fetch(`/api/v1/carburant/stock/${deletingInfo.id}`, {
            method: 'DELETE',
          })
          break
        default:
