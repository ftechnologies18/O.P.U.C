...
export function PointageView() {
  ...
  const loadFormData = useCallback(async () => {
    ...
    try {
      ...
      const affRes = await fetch(`/api/pointage/affectations?chantierId=${chantierId}`)
      ...
      const ptgRes = await fetch(`/api/pointage?chantierId=${chantierId}&date=${dateStr}`)
      ...
      const allRes = await fetch(`/api/pointage?chantierId=${chantierId}`)
